...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference('Salary.count') do
      post salaries_url, params: { salary: { employee_id: @salary.employee_id, total_salary: @salary.total_salary } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { employee_id: @salary.employee_id, total_salary: @salary.total_salary } }
